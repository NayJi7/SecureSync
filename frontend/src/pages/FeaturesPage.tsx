        ...
        <Header 
          ...
          <main className="flex-grow container mx-auto px-4 pt-32 pb-12">
            <div className="max-w-6xl mx-auto">
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white text-center">Fonctionnalités</h1>
              ...
              <section className="mb-16 backdrop-blur-md bg-black/40 p-8 rounded-lg border border-green-900/30">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                  <div>
                    <h2 className="text-3xl font-semibold mb-4 text-green-300">Solution complète de gestion pénitentiaire</h2>
                    ...
                    <ul className="space-y-3">
                      <li className="flex items-start">
                        <div className="flex-shrink-0 h-6 w-6 rounded-full bg-green-900/30 flex items-center justify-center mr-3 mt-0.5">
                  ...
                  <div className="relative h-64 md:h-full flex items-center justify-center">
                    <div className="w-full h-64 bg-green-900/20 rounded-lg flex items-center justify-center">
                      <Shield className="h-24 w-24 text-green-400/50" />
                      <p className="absolute bottom-4 text-sm text-green-300/50">
              ...
              <Tabs 
                ...
                className="mb-16"
              >
                <div className="backdrop-blur-md bg-black/40 p-6 rounded-t-lg border border-green-900/30 border-b-0">
                  <TabsList className="grid grid-cols-2 md:grid-cols-4 gap-4 mx-auto w-full max-w-3xl">
                    <TabsTrigger 
                      value="security" 
                      className="data-[state=active]:bg-green-900/50 data-[state=active]:text-white"
                    >
                ...
                <div className="backdrop-blur-md bg-black/40 p-8 rounded-b-lg border border-green-900/30">
                  <TabsContent value="security" className="mt-0">
                    <h3 className="text-2xl font-semibold mb-6 text-green-300">Sécurité avancée</h3>
                    ...
                    <div className="bg-green-900/20 p-6 rounded-lg border border-green-900/30">
                      ...
                      <img className="w-full h-48 object-cover rounded-lg bg-black/40 mb-4" />
                      <div className="flex flex-wrap gap-2">
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Alertes en temps réel</Badge>
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Verrouillage d'urgence</Badge>
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Coordination des équipes</Badge>
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Procédures automatisées</Badge>
                      </div>
                    </div>
                  </TabsContent>
                  
                  <TabsContent value="monitoring" className="mt-0">
                    <h3 className="text-2xl font-semibold mb-6 text-green-300">Surveillance intelligente</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                      <SpotlightCard className="h-full" spotlightColor="rgba(45, 161, 51, 0.2)">
                        <div className="w-12 h-12 bg-green-900/30 rounded-full flex items-center justify-center mb-4">
                    ...
                    <div className="bg-green-900/20 p-6 rounded-lg border border-green-900/30">
                      ...
                      <img className="w-full h-48 object-cover rounded-lg bg-black/40 mb-4" />
                      <div className="flex flex-wrap gap-2">
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Vue multi-caméras</Badge>
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Replay instantané</Badge>
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Analyse comportementale</Badge>
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Zones d'intérêt</Badge>
                      </div>
                    </div>
                  </TabsContent>
                  
                  <TabsContent value="management" className="mt-0">
                    <h3 className="text-2xl font-semibold mb-6 text-green-300">Gestion complète</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                      <SpotlightCard className="h-full" spotlightColor="rgba(45, 161, 51, 0.2)">
                        <div className="w-12 h-12 bg-green-900/30 rounded-full flex items-center justify-center mb-4">
                    ...
                    <div className="bg-green-900/20 p-6 rounded-lg border border-green-900/30">
                      ...
                      <img className="w-full h-48 object-cover rounded-lg bg-black/40 mb-4" />
                      <div className="flex flex-wrap gap-2">
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Rapports personnalisables</Badge>
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Visualisation des données</Badge>
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Analyse prédictive</Badge>
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Exportation multi-formats</Badge>
                      </div>
                    </div>
                  </TabsContent>
                  
                  <TabsContent value="integration" className="mt-0">
                    <h3 className="text-2xl font-semibold mb-6 text-green-300">Intégration des systèmes</h3>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                      <SpotlightCard className="h-full" spotlightColor="rgba(45, 161, 51, 0.2)">
                        <div className="w-12 h-12 bg-green-900/30 rounded-full flex items-center justify-center mb-4">
                    ...
                    <div className="bg-green-900/20 p-6 rounded-lg border border-green-900/30">
                      ...
                      <img className="w-full h-48 object-cover rounded-lg bg-black/40 mb-4" />
                      <div className="flex flex-wrap gap-2">
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Interface unifiée</Badge>
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Contrôle multi-systèmes</Badge>
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Automatisation</Badge>
                        <Badge className="bg-green-900/50 text-green-300 hover:bg-green-900">Personnalisation</Badge>
                      </div>
                    </div>
                  </TabsContent>
                </div>
              ...
              <section className="mb-16">
                <h2 className="text-3xl font-semibold mb-8 text-center text-green-300">Éditions disponibles</h2>
                
                <div className="overflow-x-auto">
                  <table className="w-full backdrop-blur-md bg-black/40 rounded-lg border border-green-900/30">
                    <thead>
              ...
              {/* Témoignages clients */}
              <section className="mb-16">
                <h2 className="text-3xl font-semibold mb-8 text-center text-green-300">Ce que nos clients disent</h2>
              ...
              {/* FAQ */}
              <section className="mb-16 backdrop-blur-md bg-black/40 p-8 rounded-lg border border-green-900/30">
                <h2 className="text-3xl font-semibold mb-8 text-center text-green-300">Questions fréquentes</h2>
