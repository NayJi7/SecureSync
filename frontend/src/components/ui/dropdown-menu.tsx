  ...
  return (
    <DropdownMenuPrimitive.Item
      ...
      className={cn(
        ...
        "data-[variant=danger]:text-red-600 data-[variant=danger]:hover:bg-red-600 data-[variant=danger]:hover:text-white data-[variant=danger]:focus:bg-red-600 data-[variant=danger]:focus:text-white",
